...
import com.dataeye.hadoop.mapreduce.v2.role.RoleInfoProcessMapper;

public class RoleInfoProcessMapReduceTest {
	private MapDriver<LongWritable, Text, DEDynamicKV, DEDynamicKV> mapDriver;
	private String logFileLocalPath = "D:/logs/roleRolling.log";
	...
	@Before
	public void setUp() {
		RoleInfoProcessMapper map = new RoleInfoProcessMapper();
